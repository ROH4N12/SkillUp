    ...
    if (learners.length > 0) {
      for (const learner of learners) {
        ...
        await Notification.create([
          { user: learner._id, title: "Welcome to SkillUp!", message: "Your personalized Frontend Development path is ready.", type: "system" },
          { user: learner._id, title: "Course Reminder", message: "Continue your React Fundamentals course to stay on track!", type: "reminder" },
        ]);
      }
